...
const Pos = () => {
  return (
    <>
      <div id='kt_app_content' className='app-content flex-column-fluid'></div>

      <div id='kt_app_content_container' className='app-container container-xxl'>
        <div className='d-flex flex-column flex-xl-row'>
          <div className='d-flex flex-row-fluid me-xl-9 mb-10 mb-xl-0'></div>
                ...
                <li className='nav-item mb-3 me-0'>
                  ...
                  >
                    ...
                    <div className='nav-icon mb-3'>
                      {/*begin::Food icon*/}
                      <img
                        src='assets/media/svg/food-icons/spaghetti.svg'
                        className='w-50px'
                        alt=''
                      />
                      {/*end::Food icon*/}
